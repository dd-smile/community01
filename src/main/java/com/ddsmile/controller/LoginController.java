...
//        System.out.println("我进来了！");
    ...
    /**
     * 生成验证码
     * @param response response对象,手动的返回验证码图片
     * @param session
     */
     ...
     * @param password  密码
     * @param code  验证码
     * @param rememberme 超时的时间
     * @param model 模板
     * @param session 用于读取session中的数据
    ...
    public String logout(@CookieValue("ticket") String ticket){
        //上面登录时，把ticket放进了cookie, 现在使用注解要求把cookie传进来
